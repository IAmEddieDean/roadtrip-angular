...
.config(function($stateProvider, $urlRouterProvider){
  ...
  .state('trips.list', {url: '/list', templateUrl: '/views/trips/trips-list.html', controller: 'TripsListCtrl'})
  .state('trips.show', {url: '/trips/{tripId}', templateUrl: '/views/trips/trips-show.html', controller: 'TripsShowCtrl'});
});
